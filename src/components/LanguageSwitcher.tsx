    ...
    <>
      <div className='relative z-[1001]'>
        ...
        >
          ...
          <div className='relative flex items-center gap-2'>
            ...
            {/* Dropdown arrow */}
            <svg
              className={`w-3 h-3 text-white/60 transform transition-transform duration-200 ${
                isOpen ? 'rotate-180' : ''
              }`}
              fill='none'
              stroke='currentColor'
      ...
      {mounted &&
        ...
        createPortal(
          <div
            ref={dropdownRef}
            className='fixed w-40 bg-black/95 backdrop-blur-xl border border-white/30 rounded-xl shadow-2xl overflow-hidden animate-fade-in-up language-dropdown-overlay'
            style={{
